...
```{r Section 2, echo=TRUE, warning = FALSE, eval = TRUE}
...
Farthing, T.S., Dawson, D.E., Sanderson, M.W., and Lanzas, C. in Press. Accounting for space and uncertainty in real-time location system-derived contact networks. *Ecology and Evolution.* https://doi.org/10.1002/ece3.6225.
