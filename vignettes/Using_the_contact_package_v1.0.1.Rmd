...
stats::chisq.test(x = observedVec, p = expectedProb) #it looks like, on average, there are indeed a different number of observed empirical contacts each hour than we might expect at random (assuming an alpha-level of 0.05).
