...
#' 
#' The function will append five columns to x. 1.) planar.x - the planar x coordinate derived from longitude, 2.) planar.y - the planar y coordinate derived from latitude, 3.) origin.lon - the longitude of the origin point, either user specified or the longitude of the data's centroid, 4.) origin.lat - the latitude of the origin point, either user specified or the latitude of the data's centroid, 5.) origin.distance - linear distance (m) between every point and the origin point.
