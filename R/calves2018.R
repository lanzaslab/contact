...
#'    1.5-year-old castrated male cattle (i.e., steer) kept in a 30 X 35 m2 pen
#'    at the Kansas State University Beef Cattle Research Center in Manhattan, KS.
#' 
...
#'   \item{dateTime}{UTC time and date at which location fix was obtained}
#' }
