...
#' @param shuffleUnit Description imminent
#' @param indivPaths Description imminent
...
randomizePaths<-function(x = NULL, id = NULL, dateTime = NULL, point.x = NULL, point.y = NULL, poly.xy = NULL, parallel = TRUE, dataType = "Point", numVertices = 4, blocking = TRUE, blockUnit = "mins", blockLength = 10, shuffle.type = 0, shuffleUnit = "Days", indivPaths = TRUE, numRandomizations = 10){
