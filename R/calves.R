#' Real-time location data for 70 calves
#'
#' A dataset containing planar real-time point locations for 70 calves between 00:00:00 and 12:00:00 UTC on May 2nd, 2016.
...
#' @docType data
#' @usage data(calves)
#' @format A data frame with 577090 rows and 5 variables:
#' \describe{
...
#' @references Dawson, D.E., Farthing, T.S., Sanderson, M.W., and Lanzas, C. 2019. Transmission on empirical dynamic contact networks is influenced by data processing decisions. Epidemics 26:32-42. 
